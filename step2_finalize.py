    ...
    for i, student_name in enumerate(unplaced_names):
        ...
        if cg is not None and conflict_pairs:
            ...
            if safe_classes:
                ...
                raise ValueError(
                    "ΜΗ ΕΦΙΚΤΗ ΚΑΤΑΝΟΜΗ: δεν υπάρχει conflict-free τμήμα "
                    f"για τον/τη μαθητή/τρια {student_name}. Δεν εφαρμόστηκε fallback "
                    "που παραβιάζει δεσμευτικό περιορισμό μη συνύπαρξης."
                )
